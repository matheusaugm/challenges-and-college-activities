...
// ler do teclado
 ...
 scanf ( "%lf", &x );
// OBS.: Necessario indicar o endereco -> &// mostrar valor lido
 printf ( "%s%lf\n", "x = ", x );
// encerrar
...
---------------------------------------------- previsao de testes
a.) 0.5 --> Apresentou o resultado 0.5000
b.) -0.5 --> Apresentou o resultado -0.5000
c.) 1.23456789 --> Apresentou o resultado 1.2345678
---------------------------------------------- historico
